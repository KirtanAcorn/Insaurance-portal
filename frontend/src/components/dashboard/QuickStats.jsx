import { Activity, Globe, CheckCircle, Shield } from "lucide-react";

const QuickStats = ({ isDark, getColorClassesDashbaord, quickStats }) => {
  const stats = [
    {
    ...
    {
      title: 'Claim Success',
      value: `${quickStats.claimSuccess}%`,
      icon: CheckCircle,
      color: 'green',
    },
    {
      title: 'Renewal Percentage',
      value: `${quickStats.dataSecurity}%`,
      icon: Shield,
      color: 'purple',
    },
  ];
