  ...
  return (
    <>
        ...
        <div className="fixed inset-0 bg-black/80 bg-opacity-50 flex items-center justify-center z-50 p-4 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0">
          <div className={`w-full max-w-4xl rounded-xl shadow-2xl transition-colors max-h-[90vh] overflow-hidden flex flex-col ${
            ...
            <div className={`px-6 py-3 border-b flex-shrink-0 ${
              ...
              <div className="flex space-x-1">
                <button
                  onClick={() => openActiveTabClaim('claim')}
                  className={`flex items-center space-x-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors cursor-pointer${
                    activeTabClaim === 'claim'
                ...
                <button
                  onClick={() => openActiveTabClaim('policy')}
                  className={`flex items-center space-x-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors cursor-pointer ${
                    activeTabClaim === 'policy'
                      ? isDark ? 'bg-purple-600 text-white' : 'bg-purple-50 text-purple-600 border border-purple-200'
                      : isDark ? 'text-gray-300 hover:text-white hover:bg-gray-700' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-100'
                  }`}
                >
                  <span className="w-4 h-4 rounded-full bg-purple-500 flex items-center justify-center text-xs text-white">P</span>
                      ...
                      <div className="mb-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          <div className="md:col-span-2">
                            ...
                            <div className={`px-3 py-2 rounded-lg border text-green-500 font-semibold ${isDark ? 'bg-gray-700 border-gray-600' : 'bg-gray-50 border-gray-300'}`}>
